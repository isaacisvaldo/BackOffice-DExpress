...
export interface CompanyContractDto extends BaseContract {
...
export interface IndividualContractDto extends BaseContract {
...
export type CreateContractDto = CompanyContractDto | IndividualContractDto;
